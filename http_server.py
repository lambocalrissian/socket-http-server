...
def response_ok(body=b"The request was successful", mimetype=b"text/plain"):
    """
...
def response_method_not_allowed():
    ...
    return b"\r\n".join([
        ...
        b"",
        b"The server recognizes the method and path",
        b"but this particular method does not make sense",
        b"when run against this particular path"
    ])
...
def response_not_found():
    ...
    return b"\r\n".join([
        ...
        b"Content-Type: text/plain",
        b"",
        b"The path does not name an existing resource",
        b"This is probably the most famous or infamous exception",
        b"code because users never see the 200 code displayed",
        b"on their screen; they see a document instead",
    ])
